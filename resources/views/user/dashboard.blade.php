...
@section('content')  
    ...
    <div class="flex flex-col mb-16 space-y-4 md:flex-row md:space-y-0 md:space-x-10">
        <button onclick="openRecordPopup()" class="flex flex-col items-center justify-center w-full h-40 py-4 text-xl text-white bg-purple-900 rounded-lg hover:bg-purple-800 ">
            <i class="mb-4 text-3xl fas fa-microphone"></i>
            Record Audio
        </button>
        <button onclick="openUploadPopup()" class="flex flex-col items-center justify-center w-full h-40 py-4 text-xl text-white bg-teal-500 rounded-lg hover:bg-teal-600">
        ...
        <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <i class="absolute text-gray-500 pointer-events-none fas fa-chevron-down right-3 top-3"></i>
                    <button type="submit" class="px-4 py-4 mt-4 font-semibold text-white bg-blue-600 rounded">Upload and Transcribe</button>
                </div>
