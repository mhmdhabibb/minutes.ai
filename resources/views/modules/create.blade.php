    ...
    <div class="min-h-screen">
        ...
        <div class="p-8 ml-64">
            <div class="max-w-2xl mx-auto">
                <h1 class="mb-6 text-2xl font-bold">Create New Module</h1>

                <form action="{{ route('modules.store') }}" method="POST" class="px-8 pt-6 pb-8 mb-4 bg-white rounded shadow-md">
                    @csrf
                    <div class="mb-4">
